...
To setup a `targets` pipeline, you will need to setup the base makefile named `_targets.R` that will declare and orchestrate the rest of the pipeline connections.
